...
const Hero = () => {
  ...
  const profileImagePath = isDarkMode 
    ? "src/assets/profile.png" 
    : "src/assets/profilewhite1.png";
...
>
  ...
  <div>
    ...
    <a
      ...
      className="absolute left-4 bottom-36 z-50 md:left-10"
    >
      <button className="px-3 py-1.5 rounded-full text-xs font-medium backdrop-blur-sm border border-foreground/10 dark:bg-black/30 bg-white/30 shadow-md">
        Photography ↗
      </button>
    </a>
  </div>
